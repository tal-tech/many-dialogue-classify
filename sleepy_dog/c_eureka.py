...
def _eureka_register():
    try:
        ...
        g_logger.info("eureka get hostname: {}, server host: {}, instance_id: {}".format(hostname, server_host, instance_id))
        ...
        g_logger.error('Init eureka server wrong, the error message is {}, the EUREKA_SERVER is {}'.format(e, Config.EUREKA_URL))
